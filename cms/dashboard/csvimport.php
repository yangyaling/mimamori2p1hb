...
$connectionOptions = array('Database' => DATABASE, 'Uid' => $loginUser->getHostCd(), 'PWD' => PWD, 'CharacterSet' => 'UTF-8');
        ...
        foreach ($userList as $data) {
            ...
            if (!is_empty($customerId)) {
                ...
                foreach ($data['vzc'] as $value) {
                    if (!createVZConfig($conn, $staffId, $customerId, $value, $today, true, $vzHistory, $code, $errors)) {
                        break;
                    }
                }
            } else {
